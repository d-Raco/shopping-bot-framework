...
def check(driver, url):
    '''Check the availability of a Fnac product by opening its URL and parsing the website contents.
    ...
    for b in buttons:
        if b.has_attr('data-automation-id'):
            if b['data-automation-id'] == 'product-buy-btn':
                return True
